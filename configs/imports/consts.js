...
const { arcloud , identificarMusica} = require('../../arquivos//js/arcc.js');
...
const { wait, getExtension, generateMessageID, getMembros, getGroupAdmins, getRandom, banner, banner2, banner3, temporizador, chyt, getBuffer, fetchJson, fetchText, createExif, getBase64, convertSticker, upload, carregarMidia,nit, getpc, supre, recognize } = require('../../arquivos//funcoes/functions.js'); // É necessário para algumas funções funcionar perfeitamente.
...
// [JSON] - Funções Abaixo >>> :
const pushnames = JSON.parse(fs.readFileSync('./arquivos/database/usuarios/users.json'));
const rgtake = JSON.parse(fs.readFileSync('./arquivos/database/usuarios/take.json'));
...
const nescessario = JSON.parse(fs.readFileSync('./configs/INFO_DADOS/nescessario.json'));
const vip = JSON.parse(fs.readFileSync('./arquivos/database/usuarios/vip.json'));
const ban = JSON.parse(fs.readFileSync('./arquivos/database/usuarios/banned.json'));
const muted = JSON.parse(fs.readFileSync('./arquivos/database/grupos/muted.json'))
const limitefll = JSON.parse(fs.readFileSync('./arquivos/database/usuarios/flood.json'));
const aluguel = JSON.parse(fs.readFileSync("./arquivos/database/grupos/aluguel/aluguel.json"))
const joguinhodavelhajs = JSON.parse(fs.readFileSync('./arquivos/database/usuarios/joguinhodavelha.json'));
const joguinhodavelhajs2 = JSON.parse(fs.readFileSync('./arquivos/database/usuarios/joguinhodavelha2.json'));
const grupos = JSON.parse(fs.readFileSync("./arquivos/database/grupos/aluguel/grupos.json"))
const chaves = JSON.parse(fs.readFileSync("./arquivos/database/grupos/aluguel/chaves.json"))
...
const setting = JSON.parse(fs.readFileSync('./configs/INFO_DADOS/settings.json'));
const logoslink = JSON.parse(fs.readFileSync('./configs/LOGOS/links_img.json'));
...
try {
datasimi = await fetchJson(`https://api.nexfuture.com.br/api/ias/gemini/gemini-2.5?apikey=72f831b2-f25f-4f64-b9b7-d4063eaf4deb&query=${encodeURIComponent(text)}`);
return datasimi.resultados.resposta;
} catch (e){
return
}};
