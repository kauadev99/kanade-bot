 ...
 */
 const addBanned = (userId, expired, _data) => {
    ...
    _data.push(obj)
    fs.writeFileSync('./arquivos/database/usuarios/banned.json', JSON.stringify(_data))
}
/**
 * Unbanned someone.
 * @param {String} userId 
...
const BannedExpired = (_dir) => {
    setInterval(() => {
        ...
        if (position !== null) {
            ...
            fs.writeFileSync('./arquivos/database/usuarios/banned.json', JSON.stringify(_dir))
        }
    }, 1000)
}
/**
